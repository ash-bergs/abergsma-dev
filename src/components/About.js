        ...
        <div className="main-grid-system">
            <div className="row">
                <div className="col-1-of-2 u-center-content u-increase-height">
                    ...
                    <p className="small-text">I have a passion for creating beautiful and accessible web and mobile applications. I believe the internet is for everyone, and accessibility-minded design makes it that way.</p>
                    <p className="small-text">I'm proficient with the MERN stack, but learning new libraries and languages are a welcome challenge. As a developer my journey to learn is never over, I'm currently tackling NextJs and LottieFiles. </p>
                </div>
