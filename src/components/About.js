...
function About() {
    ...
    return(
        <div className="main-grid-system" style={{ marginTop: '1.5%'}}>
            <div className="row">
                <div className="col-1-of-2 u-center-content u-increase-height">
                    ...
                    <p className="small-text">I believe the internet is for everyone, and accessibility-minded design keeps it that way. I have a passion for creating beautiful and accessible web and mobile applications, and writing illuminating technical articles.</p>
                </div>
